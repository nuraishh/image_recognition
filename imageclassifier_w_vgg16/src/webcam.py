...
from utils import predict_frame, key_action, init_cam, add_text
    ...
    try:
        ...
        while key != 'q':
            ...
            if key == 'space':
                ...
                # predict image in the frame
                predictn = predict_frame(image)
                # add text
                #add_text(predictn, image)
                print(predictn)
            ...
            # display the text to video stream
            #cv2.putText(frame, 'my text')
